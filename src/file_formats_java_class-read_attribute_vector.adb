...
begin
   for Attribute_Index in 1 .. u2.Big_Endian'Input (Stream) loop
      declare
         ...
         Data   :
           Octet_Memory_Stream.Octet_Array
      ...
      begin
         ...
         declare
            Attribute_Stream : constant Octet_Memory_Stream.Stream_Access :=
                  ...
                  when others =>
                     return
                       raise Possible_Misalignment
                         with "Element Value has bad tag of " & Tag'Image;
               end case;
            ...
            case Attribute_Type is
               ...
               when Code =>
                  ...
                  begin
                     ...
                     for Index in 1 .. u2.Big_Endian'Input (Attribute_Stream)
                     loop
                        declare
                     ...
                     Read_Attribute_Vector
                       (Attribute_Stream, Attributes, Pool);
                     Item.Append
                       (Class_File_Attribute'
                          (Attribute_Type       => Code,
                           Name_Ref             => Name,
               ...
               when StackMapTable =>
                  ...
                  begin
                     for Index in 1 .. u2.Big_Endian'Input (Attribute_Stream)
                     loop
                        Byteflippers.Unsigned_8'Read
                          (Attribute_Stream, Frame_Type);
                        case Frame_Type is
                           when 0 .. 63 =>
                           ...
                           when 255 =>
                              declare
                                 ...
                                 Local_Count  : constant u2.Big_Endian :=
                                   u2.Big_Endian'Input (Attribute_Stream);
                                 Locals       : constant
                                    CFA_SMT_Verification_Type_Info_Vectors
                                     .Vector :=
                  ...
                  begin
                     ...
                     loop
                        ...
                        begin
                           ...
                           u2.Big_Endian'Read
                             (Attribute_Stream, Inner_Name_Idx);
                           u2.Big_Endian'Read
                             (Attribute_Stream, Access_Flags_Raw);
               ...
               when EnclosingMethod =>
                  declare
                     Enclosing_Class      :
                       constant Class_Constant_Pool_Entry :=
                         Class_Constant_Pool_Entry
                           (Pool.Element
                              (Constant_Pool_Index'Input (Attribute_Stream)));
               ...
               when LocalVariableTable =>
                  ...
                  begin
                     ...
                     loop
                        declare
                           Program_Counter_Start : constant u2.Big_Endian
                              := u2.Big_Endian'Input (Attribute_Stream);
                           Program_Counter_Length : constant u2.Big_Endian
                              := u2.Big_Endian'Input (Attribute_Stream);
                           Name_Ref               : constant
                              Utf_8_Constant_Pool_Entry
                              := Utf_8_Constant_Pool_Entry (Pool.Element
                              (Constant_Pool_Index'Input (Attribute_Stream)));
                           Descriptor_Ref         : constant
                              Utf_8_Constant_Pool_Entry
                              := Utf_8_Constant_Pool_Entry (Pool.Element
                              (Constant_Pool_Index'Input (Attribute_Stream)));
                           Frame_Index            : constant u2.Big_Endian
                              := u2.Big_Endian'Input (Attribute_Stream);
                        begin
                     ...
                     loop
                        declare
                           ...
                           Frame_Index            : constant u2.Big_Endian
                              := u2.Big_Endian'Input (Attribute_Stream);
                        begin
                           Local_Variable_Types_Vector.Append
               ...
               =>
                  ...
                  begin
                     for Index
                       in 1 .. Byteflippers.Unsigned_8'Input (Attribute_Stream)
                     loop
                        declare
                  ...
                  Item.Append
                    (Class_File_Attribute'
                       (Attribute_Type => AnnotationDefault,
                        Name_Ref       => Name,
                        Default_Value  =>
                          new CFA_Annotation_Element_Value'
                            (Read_Element_Value)));
                        ...
                        Item.Append
                          (Class_File_Attribute'
                             (Attribute_Type => Other,
                              Name_Ref       => Name,
                              Data           =>
                                new Octet_Memory_Stream.Octet_Array'(Data)));
